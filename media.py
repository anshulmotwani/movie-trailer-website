...
class Movie():
	# this is a constructor which is called to make space in memory for a particular instance of clss
	# it takes in attributes which are then allocated to instance variables
